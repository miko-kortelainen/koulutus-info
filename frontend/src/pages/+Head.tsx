  ...
  return (
    <>
      ...
      <link
        ...
        type="font/woff2"
      />
      <meta content={THEME_COLOR.light} media="(prefers-color-scheme: light)" name="theme-color" />
      <meta content={THEME_COLOR.dark} media="(prefers-color-scheme: dark)" name="theme-color" />
